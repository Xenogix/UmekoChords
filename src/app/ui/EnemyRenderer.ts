import { AnimatedSprite, Assets, Container, Particle, ParticleContainer, Texture, Ticker } from "pixi.js";
...
export class EnemyRenderer extends Container {
  ...
  public setEnemy(enemy: AnimatedEnemy): void {
    ...
    this.enemy = enemy;
    this.enemySprite.textures = Object.values(Assets.get(enemy.getSpriteSheetResource()).textures)
